...
static void Display_PlainData(void)
{
  ...
  {
    printf("[0x%8X]", (unsigned int)PlainData[i]);
    count++;
  ...
  for(i = 0; i < 4; i++)
  {
    printf("[0x%8X]", (unsigned int)AES128key[i]);
    count++;
  }
}
...
static void Display_EncryptedData(void)
{
  ...
  for(i = 0; i < DATA_SIZE; i++)
  {
    printf("[0x%8X]", (unsigned int)EncryptedData[i]);
    count++;
...
static void Display_DecryptedData(void)
{
  ...
  for(i = 0; i < DATA_SIZE; i++)
  {
    printf("[0x%8X]", (unsigned int)DecryptedData[i]);
    count++;
